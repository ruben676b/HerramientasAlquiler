...
export const SEMANTIC = {
  ...
  cancelado:                { variable: 'var(--muted)',   color: 'oklch(0.52 0.005 50)', soft: 'oklch(0.90 0.003 60)', label: 'Cancelado' },
  ...
  vendido:       { variable: 'var(--success)', color: 'oklch(0.55 0.15 160)', soft: 'oklch(0.93 0.05 160)', label: 'Vendido' },
};

export const ESTADOS_HERRAMIENTA = ['disponible', 'reservado', 'alquilado', 'mantenimiento', 'malogrado', 'perdida', 'vendido'];
