...
contextBridge.exposeInMainWorld('api', {
  ...
  editarItemContrato: (idDetalle, idContrato, data) => ipcRenderer.invoke('editar-item-contrato', idDetalle, idContrato, data),
  eliminarItemContrato: (idDetalle, idContrato) => ipcRenderer.invoke('eliminar-item-contrato', idDetalle, idContrato),
  registrarDevolucionSaldo: (idContrato, monto, metodo) => ipcRenderer.invoke('registrar-devolucion-saldo', idContrato, monto, metodo),
